...
// Define all routes for the app using lazy-loaded standalone components
const routes: Routes = [
  {
    path: '',
    redirectTo: 'home',
    pathMatch: 'full' // Redirect root path to 'home'
  },
  {
    path: 'home',
...
@NgModule({
  imports: [
    RouterModule.forRoot(routes, { preloadingStrategy: PreloadAllModules }) // Preload all modules for faster UX
  ],
